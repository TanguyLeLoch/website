...
const textDev =
  'Building a custom tailored solution based on your technical need.';
const textUnitTest =
  'Writing development associated unit tests to ensure a good behavior and avoid any regression in the future.';
