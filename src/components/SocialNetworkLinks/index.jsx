...
function SocialNetworkLinks() {
  return (
    <HoverContainer>
      <BundleLinks>
        <a href="https://www.linkedin.com/in/tanguyleloch/" target="_blank" rel="noreferrer">
          <LogoLinkedin />
        </a>
        <a href="https://github.com/TanguyLeLoch" target="_blank" rel="noreferrer">
          <LogoGithub />
        </a>
      </BundleLinks>
    </HoverContainer>
...
export { LogoGithub, LogoLinkedin };
